...
in Eq.~(\ref{eq:laplace-energy}) only with $\alpha=0$ in
...
As can be seen, the ZMP stays inside the support polygon of the area
$\pm 7.5$ cm for each x and y axis.
...
\begin{figure}[t]
  \begin{center}
    \begin{tabular}{cc}
    \includegraphics[width=0.4 \linewidth]{figure/before}&
